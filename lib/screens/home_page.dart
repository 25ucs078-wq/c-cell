  ...
  children: [
    ...
    onTap: () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => const GymkhanaPage(),
        ),
      );
    },
  ),
      ...
      buildEventCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CouncilDetailPage(council: culturalCouncil),
            ),
          );
        },
      ),
      ...
      buildEventCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CouncilDetailPage(council: technologyCouncil),
            ),
          );
        },
      ),
      ...
      buildEventCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CouncilDetailPage(council: sportsCouncil),
            ),
          );
        },
      ),
