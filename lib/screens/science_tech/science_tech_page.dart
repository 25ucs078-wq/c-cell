...
import 'science_tech_club_detail_page.dart';
...
class ScienceTechPage extends StatelessWidget {
    ...
    if (clubName == 'Cybros') {
      return [
        ...
        },
        {
          'name': 'Sushmit Sharma',
          'role': 'Coordinator',
          'image': 'assets/assets/images/Harshita.jpg',
          'phone': '+918888888888',
      ...
      return [
        {
          'name': 'Aryan Agarwal',
          'role': 'Coordinator',
          'image': 'assets/assets/images/rahul_sharma.jpg',
          'phone': '+919999999999',
      ...
      return [
        {
          'name': 'Gourav Bansal',
          'role': 'Coordinator',
          'image': 'assets/assets/images/panth_moradiya.jpg',
          'phone': '+919999999999',
        ...
        },
        {
          'name': 'Kshitij Verma',
          'role': 'Coordinator',
          'image': 'assets/images/Shriyansh.jpeg',
          'phone': '+918888888888',
      ...
      return [
        {
          ...
          'role': 'Coordinator',
          'image': 'assets/assets/images/vibha_gupta.jpg',
          'phone': '+918875967149',
        ...
        },
        {
          'name': 'Arjit Mathur',
          'role': 'Coordinator',
          'image': 'assets/assets/images/naman.jpg',
          'phone': '+919352888935',
      ...
      return [
        {
          'name': 'Aalekh Narain',
          'role': 'Coordinator',
          'image': 'assets/assets/images/armaan.png',
          'phone': '+919999999999',
        ...
        },
        {
          'name': 'Akansh Saxena',
          'role': 'Coordinator',
          'image': 'assets/assets/images/arpit_joshi.jpg',
          'phone': '+918888888888',
  ...
  static final List<Map<String, dynamic>> techClubs = [
    {
      'name': 'Astronomy',
      'icon': 'assets/assets/images/tech/astronomy/astro_logo.png',
      'subtitle': 'The Astronomy Club of LNMIIT',
      'image': 'assets/assets/images/tech/astronomy/astro_logo.png',
