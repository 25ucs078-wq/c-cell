        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(color: Color(0xFFB20710), borderRadius: BorderRadius.only(bottomLeft: Radius.circular(20), bottomRight: Radius.circular(20))),
              child: Center(child: Text("VIEW PROFILE", style: GoogleFonts.playfairDisplay(color: Colors.white, fontSize: 22, letterSpacing: 2))),
            ),
          ],
        ),
      ),
