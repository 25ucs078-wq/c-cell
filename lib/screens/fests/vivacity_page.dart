...
class VivacityPage extends StatelessWidget {
  ...
  static const List<String> galleryImages = [
    // same as desportivos and plinth gallery not updated
  ...
  static const List<Map<String, String>> festHeads = [
    {"name": "Vedang Dixit", "image": "assets/images/logo.jpeg", "role": "Fest Head", "phone": "+919999999999", "email": "vivacity@lnmiit.ac.in"}, // image, phone number not added
    {"name": "Vedant Wadhwa", "image": "assets/images/logo.jpeg", "role": "Fest Head", "phone": "+918888888888", "email": "vivacity@lnmiit.ac.in"}, // image, phone number not added
  ];
                      ...
                      Row(
                        children: [
                          ...
                          _buildFestSocialButton(
                            ...
                            url: "https://vivacity.lnmiit.ac.in/",
                          ),
                        ],
                      ),
                      const SizedBox(height: 30),
